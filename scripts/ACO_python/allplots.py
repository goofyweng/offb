...
def btour(n,nodes,queen_tour):
    ...
    for i in range(n+1): # queen tour的轉換
        ...
        qx[i]=qx[i]+x[int(queen_tour[i])]
        qy[i]=qy[i]+y[int(queen_tour[i])]
    ...
    ax[2].plot(qx,qy,'k',linewidth=2,marker='o',markerfacecolor='blue',markeredgecolor='orange',markersize=10,markeredgewidth=1.5)
